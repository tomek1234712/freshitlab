...
define( 'HICPO_URL', get_template_directory_uri() . DS . 'plugins' . DS . 'intuitive-custom-post-order' . DS );
define( 'HICPO_DIR', INC_PLUGIN_DIR . DS . "intuitive-custom-post-order" . DS );
...
class Hicpo
{
	...
	function admin_menu()
	{
		add_options_page( __( 'Posts Order', 'intuitive-custom-post-order' ), __( 'Posts Order', 'intuitive-custom-post-order' ), 'manage_options', 'hicpo-settings', array( $this,'admin_page' ) );
	}
